docker build -t cr9ver/multi-client:latest -t cr9ver/multi-client:$SHA ./client/Dockerfile ./client
docker build -t cr9ver/multi-server:latest -t cr9ver/multi-server:$SHA ./server/Dockerfile ./server
docker build -t cr9ver/multi-worker:latest -t cr9ver/multi-worker:$SHA ./server/Dockerfile ./worker
